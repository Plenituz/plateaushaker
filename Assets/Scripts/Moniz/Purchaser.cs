...
public class Purchaser : MonoBehaviour, IStoreListener{
    ...
    public const string ADS_PATH = "ha_ok";
    public static string ADS_ON = "swag is missing sorry mate";
    public static string ADS_OFF = "DAYUM dis guy gat some swag inside him";
...
//	private static string kProductIDConsumable =    "consumable";                                                         // General handle for the consumable product.
	private static string productID_noAds = "noads";
...
//	private static string kProductNameAppleConsumable =    "com.unity3d.test.services.purchasing.consumable";             // Apple App Store identifier for the consumable product.
	private static string productKeyApple_noAds = "";
...
//	private static string kProductNameGooglePlayConsumable =    "com.unity3d.test.services.purchasing.consumable";        // Google Play Store identifier for the consumable product.
	private static string productKeyAndroid_noAds = "noads";
	...
	public void InitializePurchasing() 
	{
        ...
        builder.AddProduct(productID_noAds, ProductType.NonConsumable, new IDs(){ {productKeyApple_noAds, AppleAppStore.Name}, {productKeyAndroid_noAds, GooglePlay.Name}, });
